...
3. Utilize the `./networker network scan -s` command to log your network and device information  

## Naming Your Devices

To name your devices I would first recommend running `./networker network scan -p -s` to scan your devices for open ports and save the information to the database.  
